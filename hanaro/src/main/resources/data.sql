...
VALUES
    (2, '11012345678', 'BASIC',   5000000),
    (2, '11098765432', 'DEPOSIT',       0),
    (3, '11011122233', 'BASIC',   3000000),
    (3, '11044455566', 'SAVINGS',       0);

-- ── 5. SUBSCRIPTION ──────────────────────────────────────────────
INSERT INTO Subscription (product, account, user, paymentAmount, paymentCycle, joinDate, endDate, status, maturedAt, cancelledAt)
VALUES
    (1, 2, 2, 5000000, 'MONTHLY', DATE_SUB(CURDATE(), INTERVAL 3 MONTH), DATE_ADD(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), INTERVAL 12 MONTH), 'ACTIVE',    NULL, NULL),
    (2, 4, 3,  300000, 'MONTHLY', DATE_SUB(CURDATE(), INTERVAL 1 MONTH), DATE_ADD(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), INTERVAL 12 MONTH), 'ACTIVE',    NULL, NULL),
    (3, 2, 2,  100000, 'MONTHLY', DATE_SUB(CURDATE(), INTERVAL 8 MONTH), DATE_ADD(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), INTERVAL 6 MONTH),  'CANCELLED', NULL, DATE_SUB(NOW(), INTERVAL 5 MONTH));
